...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Remember to: Write a short summary, because RubyGems requires one.}
  spec.description   = %q{Remember to: Write a longer description or delete this line.}
